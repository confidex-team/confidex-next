        ...
        <div className="flex flex-col items-center justify-center min-h-[calc(100vh-4rem)] w-full px-4">
          ...
          <div className="text-center w-full max-w-4xl mx-auto space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-4">
              <Link
                href="/swap"
                className="group flex items-center gap-2 px-6 py-3 backdrop-blur-sm bg-blue-700 text-white rounded-none font-semibold hover:bg-blue-600/90 transition-all hover:shadow-lg hover:shadow-blue-600/20"
              >
                Launch App
          ...
          <div className="bg-black/10 backdrop-blur-sm p-6 rounded-none border border-blue-600/20 hover:border-blue-600/40 transition-colors">
              ...
              <p className="text-gray-600">
                {"Tokens are wrapped with cERC20s (Confidential ERC20), ensuring native privacy"}
              </p>
            </div>
            ...
            <div className="bg-black/10 backdrop-blur-sm p-6 rounded-none border border-blue-600/20 hover:border-blue-600/40 transition-colors">
              ...
              <p className="text-gray-600">
                Protected by TEE technology ensuring your trades are matched
